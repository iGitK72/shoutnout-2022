    ...
    <div class="flex items-center justify-center h-screen bg-blue-100">
        <div class="bg-white shadow-lg rounded-lg" style="width: 45rem !important;">
            <div class="flex">
                ...
                <div class="w-full p-8">
                    <div class="flex justify-between">
                        <div>
                            <h3 class="text-2xl text-grey-600 font-medium">A Sky Full of Stars</h3>
                    ...
                    <div class="flex justify-between items-center mt-8">
                        ...
                        <div class="text-white p-8 rounded-full bg-blue-300 shadow-lg">
                            <svg class="w-8 h-8" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20">
            ...
            <div class="mx-8 py-4">
                ...
                <div class="mt-1">
                    <div class="h-1 bg-grey-400 rounded-full">
                        <div class="w-1/5 h-1 bg-blue-300 rounded-full relative">
                            <span class="w-4 h-4 bg-blue absolute pin-r pin-b -mb-1 rounded-full shadow"></span>
                        </div>
                    </div>
                </div>
            </div>
